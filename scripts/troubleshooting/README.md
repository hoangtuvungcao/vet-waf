...
|--------------------------------|-------|-------------------------------------------------------------------------|
| --troubleshooting-host         | -th | Vet-WAF Troubeshooting Server host, example (192.168.0.101)            | 
| --troubleshooting-port         | -tp | Vet-WAF Troubeshooting Server port, example (5555)                     |
| --troubleshooting-mac          | -tm | Vet-WAF Troubeshooting Server Mac Address, example (aa:bb:cc:dd:ee:ff) |
