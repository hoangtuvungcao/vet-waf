 ...
 *
 * Now each instance manages its own connection and event buffer, ensuring
 * thread-local isolation and safe flushing to the ClickHouse client.
 * Implements the IPluginProcessor interface for ABI-safe plugin usage.
 */
