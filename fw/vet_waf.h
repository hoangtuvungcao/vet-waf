 ...
 */
#ifndef __VET_WAF_H__
#define __VET_WAF_H__
...
#define TFW_AUTHOR		"Vet-WAF"
#define TFW_NAME		"Vet-WAF"
...
/**
 * Internally, Vet-WAF code is split into modules. These are not
 ...
 * @stop	- called to stop a module when Vet-WAF is stopped;
