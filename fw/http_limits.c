			     ...
			     FrangVhostCfg *f_cfg)
{
	...
	case TFW_HTTP_VER_20:
		break;
	/*
	 * Vet-WAF MUST block requests with Upgrade header but without
	 * upgrade option in Connection header. Vet-WAF MUST ignore
...
frang_resp_fwd_process(TfwHttpResp *resp)
{
	...
	/*
	 * Requests originated by Health Monitor are generated by Vet-WAF,
...
{
	/* Just a hint. Be careful calling not only for Vet-WAF's socket. */
